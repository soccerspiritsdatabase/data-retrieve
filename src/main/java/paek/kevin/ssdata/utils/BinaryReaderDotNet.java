 ...
 * @author robbiev
 * @url https://gist.github.com/vangorra/9470810
 *
 */
public class BinaryReaderDotNet extends FilterInputStream {
  ...
  public BinaryReaderDotNet(InputStream in, Charset charset) {
    super(in);
  ...
  public String readString() throws IOException {
    return new String(this.readBytes(this.getStringLength()), charset);
  }
